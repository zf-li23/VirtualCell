# Imbalanced Cell Annotation 学习笔记
...
| 属性 | 描述 |
|------|------|
| **论文** | [Foundation Models Meet Imbalanced Single-Cell Data When Learning Cell Type Annotations](https://www.biorxiv.org/content/10.1101/2023.10.24.563625v1), bioRxiv 2023 |
| **发布日期** | YYYY-MM |
| **出版** | 期刊/会议 |
