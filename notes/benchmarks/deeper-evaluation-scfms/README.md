...
| 属性 | 描述 |
|------|------|
| **论文** | [Deeper Evaluation of Single-Cell Foundation Models](https://www.nature.com/articles/s42256-024-00949-w), Nature Machine Intelligence 2024 |
| **发布日期** | YYYY-MM |
| **出版** | 期刊/会议 |
