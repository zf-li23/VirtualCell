...
| 属性 | 描述 |
|------|------|
| **论文** | [Learning the Transcriptional Grammar in scRNA-seq Data Using Transformers](https://www.nature.com/articles/s42256-023-00757-8), Nature Machine Intelligence 2023 |
| **发布日期** | YYYY-MM |
| **出版** | 期刊/会议 |
