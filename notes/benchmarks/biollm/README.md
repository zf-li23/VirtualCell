...
| 属性 | 描述 |
|------|------|
| **论文** | [BioLLM: A Standardized Framework for Integrating and Benchmarking Single-cell Foundation Models](https://www.sciencedirect.com/science/article/pii/S2666389925001746), Patterns 2024 |
| **发布日期** | YYYY-MM |
| **出版** | 期刊/会议 |
