...
| 属性 | 描述 |
|------|------|
| **论文** | [Batch Effects Remain a Fundamental Barrier to Universal Embeddings in scFMs](https://www.biorxiv.org/content/10.64898/2025.12.19.695371v1), bioRxiv 2025 |
| **发布日期** | YYYY-MM |
| **出版** | 期刊/会议 |
