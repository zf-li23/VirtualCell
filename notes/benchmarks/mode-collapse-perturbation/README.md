# Mode Collapse Perturbation 学习笔记
...
| 属性 | 描述 |
|------|------|
| **论文** | [Diversity by Design: Addressing Mode Collapse Improves scRNA-seq Perturbation Modeling](https://arxiv.org/abs/2506.22641), bioRxiv 2025 |
| **发布日期** | YYYY-MM |
| **出版** | 期刊/会议 |
