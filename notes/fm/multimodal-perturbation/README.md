...
| 属性 | 描述 |
|------|------|
| **论文** | [Multimodal Foundation Model Predicts Zero-shot Functional Perturbations](https://www.biorxiv.org/content/10.1101/2024.12.19.629561v2), bioRxiv 2025 |
| **发布日期** | YYYY-MM |
| **出版** | 期刊/会议 |
