...
| 属性 | 描述 |
|------|------|
| **论文** | [scGPT-spatial: Continual Pretraining of Single-Cell Foundation Model for Spatial Transcriptomics](https://www.biorxiv.org/content/10.1101/2025.02.05.636714v1), bioRxiv 2025 |
| **发布日期** | YYYY-MM |
| **出版** | 期刊/会议 |
