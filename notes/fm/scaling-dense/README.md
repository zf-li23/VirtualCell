...
| 属性 | 描述 |
|------|------|
| **论文** | [Scaling Dense Representations for Single Cell with Transcriptome-Scale Context](https://www.biorxiv.org/content/10.1101/2024.11.28.625303v1.full), bioRxiv 2024 |
| **发布日期** | YYYY-MM |
| **出版** | 期刊/会议 |
