...
| 属性 | 描述 |
|------|------|
| **论文** | [A Pre-trained Large Generative Model for Translating Single-cell Transcriptome to Proteome](https://www.biorxiv.org/content/10.1101/2023.07.04.547619v2), Nature Biomedical Engineering 2025 |
| **发布日期** | YYYY-MM |
| **出版** | 期刊/会议 |
