...
| 属性 | 描述 |
|------|------|
| **论文** | [Atacformer: A Transformer-based Foundation Model for Analysis and Interpretation of ATAC-seq Data](https://www.biorxiv.org/content/10.1101/2025.11.03.685753v1), bioRxiv 2025 |
| **发布日期** | YYYY-MM |
| **出版** | 期刊/会议 |
