# RNA-seq Coverage from DNA 学习笔记
...
| 属性 | 描述 |
|------|------|
| **论文** | [Predicting RNA-seq Coverage from DNA Sequence as a Unifying Model of Gene Regulation](https://www.biorxiv.org/content/10.1101/2023.08.30.555582v1), bioRxiv 2023 |
| **发布日期** | YYYY-MM |
| **出版** | 期刊/会议 |
