...
| 属性 | 描述 |
|------|------|
| **论文** | [EpiFoundation: A Foundation Model for Single-Cell ATAC-seq via Peak-to-Gene Alignment](https://www.biorxiv.org/content/10.1101/2025.02.05.636688v2), bioRxiv 2025 |
| **发布日期** | YYYY-MM |
| **出版** | 期刊/会议 |
