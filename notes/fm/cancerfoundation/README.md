...
| 属性 | 描述 |
|------|------|
| **论文** | [CancerFoundation: A Single-cell RNA Sequencing Foundation Model to Decipher Drug Resistance in Cancer](https://www.biorxiv.org/content/10.1101/2024.11.01.621087v1.full.pdf), bioRxiv 2024 |
| **发布日期** | YYYY-MM |
| **出版** | 期刊/会议 |
