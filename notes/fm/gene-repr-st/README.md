...
| 属性 | 描述 |
|------|------|
| **论文** | [A Framework for Gene Representation on Spatial Transcriptomics](https://www.biorxiv.org/content/10.1101/2024.09.27.615337v5), bioRxiv 2024 |
| **发布日期** | YYYY-MM |
| **出版** | 期刊/会议 |
