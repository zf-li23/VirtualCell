...
| 属性 | 描述 |
|------|------|
| **论文** | [Decoding Cell Fate: Integrated Experimental and Computational Analysis at the Single-Cell Level](https://academic.oup.com/bioinformatics/advance-article/doi/10.1093/bioinformatics/btaf603/8315140), Bioinformatics 2025 |
| **发布日期** | YYYY-MM |
| **出版** | 期刊/会议 |
