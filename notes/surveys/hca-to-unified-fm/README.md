...
| 属性 | 描述 |
|------|------|
| **论文** | [The Human Cell Atlas from a Cell Census to a Unified Foundation Model](https://www.nature.com/articles/s41586-024-08338-4), Nature 2024 |
| **发布日期** | YYYY-MM |
| **出版** | 期刊/会议 |
