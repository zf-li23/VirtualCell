# Joint Embed Transcript Text 学习笔记
...
| 属性 | 描述 |
|------|------|
| **论文** | [Joint Embedding of Transcriptomes and Text Enables Interactive scRNA-seq Data Exploration](https://openreview.net/forum?id=yWiZaE4k3K), ICLR Workshop MLGenX 2024 |
| **发布日期** | YYYY-MM |
| **出版** | 期刊/会议 |
