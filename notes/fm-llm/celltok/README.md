...
| 属性 | 描述 |
|------|------|
| **论文** | [CellTok: Early-Fusion Multimodal Large Language Model for Single-Cell Transcriptomics](https://www.biorxiv.org/content/10.1101/2025.10.22.684047v1), bioRxiv 2025 |
| **发布日期** | YYYY-MM |
| **出版** | 期刊/会议 |
