...
| 属性 | 描述 |
|------|------|
| **论文** | [TISSUENARRATOR: Generative Modeling of Spatial Transcriptomics with LLMs](https://www.biorxiv.org/content/10.1101/2025.11.24.690325v1.full.pdf), bioRxiv 2025 |
| **发布日期** | YYYY-MM |
| **出版** | 期刊/会议 |
