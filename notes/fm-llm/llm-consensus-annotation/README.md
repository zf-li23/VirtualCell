...
| 属性 | 描述 |
|------|------|
| **论文** | [Large Language Model Consensus Improves Cell Type Annotation Accuracy](https://www.biorxiv.org/content/10.1101/2025.04.10.647852v1), bioRxiv 2025 |
| **发布日期** | YYYY-MM |
| **出版** | 期刊/会议 |
