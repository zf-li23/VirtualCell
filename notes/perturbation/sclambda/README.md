...
| 属性 | 描述 |
|------|------|
| **论文** | [Modeling and Predicting Single-cell Multi-gene Perturbation Responses with scLAMBDA](https://www.biorxiv.org/content/10.1101/2024.12.04.626878v1), bioRxiv 2024 |
| **发布日期** | YYYY-MM |
| **出版** | 期刊/会议 |
