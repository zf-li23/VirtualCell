# Diffusion Debiasing Perturbation 学习笔记
...
| 属性 | 描述 |
|------|------|
| **论文** | [Predicting the Unseen: A Diffusion-based Debiasing Framework](https://www.pnas.org/doi/10.1073/pnas.2525268122), PNAS 2025 |
| **发布日期** | YYYY-MM |
| **出版** | 期刊/会议 |
