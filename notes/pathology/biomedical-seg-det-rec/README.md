...
| 属性 | 描述 |
|------|------|
| **论文** | [A Foundation Model for Joint Segmentation, Detection and Recognition of Biomedical Objects](https://www.nature.com/articles/s41592-024-02499-w), Nature Methods 2024 |
| **发布日期** | YYYY-MM |
| **出版** | 期刊/会议 |
