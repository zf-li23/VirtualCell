...
export const noteMetas: NoteMeta[] = [
  ...
  { id: 'tabulam', title: 'Tabula (Tabular Pretraining for scRNA-seq)', category: 'FM + 经典语言模型', path: 'fm-classic/tabulam/README.md' },
  ...
  { id: 'visual-omics-fm', title: 'A visual–omics foundation model', category: 'FM + 空间组学', path: 'fm-spatial/visual-omics-fm/README.md' },

  // --- FM + 世界模型 ---
  { id: 'genejepa', title: 'GeneJEPA', category: 'FM + 世界模型', path: 'fm-world-model/genejepa/README.md' },

  // --- FM + 跨物种/通用嵌入 ---
  { id: 'cell-atlas-fm', title: 'UCE', category: 'FM + 跨物种/通用嵌入', path: 'fm-cross-species/cell-atlas-fm/README.md' },
  ...
  { id: 'perturbation-linear-baselines', title: 'Simple Linear Baselines for Perturbation Prediction', category: '遗传扰动', path: 'perturbation/perturbation-linear-baselines/README.md' },
  ...
  // --- 评估与 Benchmark ---
  { id: 'biology-driven-insights', title: 'Biology-Driven Insights in Single-Cell Foundation Models', category: '评估与 Benchmark', path: 'benchmarks/biology-driven-insights/README.md' },
  { id: 'deeper-evaluation-scfms', title: 'Deeper Evaluation of Single-Cell Foundation Models', category: '评估与 Benchmark', path: 'benchmarks/deeper-evaluation-scfms/README.md' },
  { id: 'metric-mirages', title: 'Metric Mirages in Cell Embeddings', category: '评估与 Benchmark', path: 'benchmarks/metric-mirages/README.md' },
  ...
  { id: 'ssl-effective-use', title: 'When Does Self-Supervised Learning Work in scRNA-seq?', category: '评估与 Benchmark', path: 'benchmarks/ssl-effective-use/README.md' },
  ...
  { id: 'whole-slide-fm', title: 'Prov-GigaPath / Whole-Slide Foundation Model', category: '病理基础模型', path: 'pathology/whole-slide-fm/README.md' },

  // --- 综述与展望 ---
  { id: 'build-virtual-cell-ai', title: 'How to Build the Virtual Cell with Artificial Intelligence: Priorities and Opportunities', category: '综述与展望', path: 'surveys/build-virtual-cell-ai/README.md' },
