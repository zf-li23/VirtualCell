...
const notePathToId: Record<string, string> = {
  ...
  'fm-llm/cellforge/README.md': 'cellforge',
  ...
  'fm-llm/vcworld/README.md': 'vcworld',
  'fm-multi-omics/captain/README.md': 'captain',
  'fm-multi-omics/scprotein/README.md': 'scprotein',
  'fm-multi-omics/spatranslator/README.md': 'spatranslator',
  'fm-multi-omics/switch/README.md': 'switch',
  ...
  'surveys/the-virtual-cell/README.md': 'the-virtual-cell',
